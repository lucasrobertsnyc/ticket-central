  ...
  return (
    <div className="bg-[#0f172a] rounded-xl border border-white/10 shadow-lg p-5 mb-4">
      ...
      <div className="flex items-start gap-3 mb-5">
        <div className="w-9 h-9 rounded-lg bg-blue-600/20 border border-blue-500/30 flex items-center justify-center flex-shrink-0 mt-0.5">
          <svg className="w-4.5 h-4.5 text-blue-400" style={{ width: 18, height: 18 }} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          ...
          <button
            ...
            className="w-full bg-blue-600 hover:bg-blue-500 disabled:opacity-60 disabled:cursor-not-allowed
                       text-white font-semibold text-sm rounded-lg py-2.5 transition-colors mt-1
